...
local i = gears.filesystem.get_configuration_dir().."icons/tags/64/"
print(i)
local layouts = awful.layout.layouts
local tags = {
  settings = {
    { names  = { "󰢻", "󰖟", "󰅩", "󱆀","󰤱","󱃸","󰐕","󰐕","󰐕" },
      layout = { layouts[1], layouts[4], layouts[1], layouts[1], layouts[3],layouts[4],layouts[1],layouts[1],layouts[1]},
      icons = {i .."006-settings.png", i .."001-browser.png", i .. "005-coding.png",  i .."008-pencil.png",  i .."007-pin.png", i .. "003-browser-2.png", i .. "plus.png", i .. "plus.png", i .. "plus.png"}
    },
    { names  = { "󰢻", "󰖟", "󱃸",  "󱆀", "󰤱", "󰅩", "󰐕", "󰐕", "󰎉" },
      layout = { layouts[4], layouts[4], layouts[4], layouts[1], layouts[3],layouts[1],layouts[1],layouts[1],layouts[4]},
      icons = { i .."002-browser-1.png", i ..  "001-browser.png", i ..  "003-browser-2.png", i .. "008-pencil.png", i .. "007-pin.png", i .."005-coding.png", i .. "plus.png", i .. "plus.png", i .. "004-music-note.png"}
}}}
...
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    set_wallpaper(s)
    local val = tags.settings[s.index]
    for j = 1,10 do
        awful.tag.add(val.names[j],{
            layout = val.layout[j],
            screen = s
        })
    end
    --tags[s] = awful.tag(tags.settings[s.index].names, s, tags.settings[s.index].layout, tags.settings[s.index].icons)
    -- Each screen has its own tag table.
    --awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
  --   local i = "icons/tags/64/"
  --   local layouts = awful.layout.layouts
  -- --if s.index == 0 or s.index == 1 then
  --   awful.tag.add("1",{
  --       icon               = i .. "006-settings.png",
  --       layout             = layouts[1],
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("rofi -no-lazy-grab -show drun -modi drun -theme " .. gears.filesystem.get_configuration_dir() .. "../rofi/config") end,
...
print(beautiful.get_font("Material-Design-Icons"))
